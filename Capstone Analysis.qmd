...
Miller and colleagues (2025) explored the role of GAMs in analyzing seller behaviors on darknet markets, where fraudulent activities are common. Their study revealed that costly signals such as reputation and escrow usage were linked to reduced fraud, while cheap signals like overly complex product descriptions correlated with higher fraud likelihood. GAMs were used to model nonlinear effects of these behavioral variables, supporting signaling theory in fraud contexts and providing patterns for monitoring fraudulent behavior. 
